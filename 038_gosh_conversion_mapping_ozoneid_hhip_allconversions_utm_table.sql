...
WHERE conversion_All_Site_Visitors IS NOT NULL
UNION ALL
SELECT 
date_ts,
request_id,
...
FROM (
    ...
    FROM `ozone-analytics-dev.analytics.038_gosh_conversion_mapping_ozoneid_hhip_allconversions_utm_table` AS fc
) AS pre_flattened
